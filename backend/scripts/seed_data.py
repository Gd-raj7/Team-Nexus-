"""
CivicNexus AI — Deterministic Seed Data Generator
...
WARDS = {
    "Zone 1 - Downtown Financial Core": {"center": (19.0250, 72.8350)},
    "Zone 2 - Port & Logistics Hub": {"center": (19.0320, 72.8420)},
    "Zone 3 - Coastal Bay & Education Hub": {"center": (19.0760, 72.8780)},
    "Zone 4 - Industrial Ring": {"center": (19.0650, 72.8600)},
    "Zone 5 - West Bay Commercial Belt": {"center": (19.0540, 72.8400)},
    "Zone 6 - Central Transit Ring": {"center": (19.0900, 72.8500)},
    "Zone 7 - Metro Tech Corridor": {"center": (19.1190, 72.8470)},
    "Zone 8 - Highland Suburban Sector": {"center": (19.1300, 72.8600)},
    "Zone 9 - North Lakefront Smart Hub": {"center": (19.1400, 72.8700)},
    "Zone 10 - Southern Highway Corridor": {"center": (19.1500, 72.8800)},
}
...
# Zone 7 - Metro Tech Corridor, radius ~150m, July 1-4

SCENARIO_1_REPORTS = [
    {
        "report_id": "NX-2026-1001",
        "timestamp": "2026-07-01T08:30:00+05:30",
        "citizen_name": "Rajesh Kumar",
        "phone": "+91-98200-10001",
        "location": {"latitude": 19.1190, "longitude": 72.8470, "address": "Tech Junction Hub, Zone 7 Sector A", "ward": "Zone 7 - Metro Tech Corridor"},
        "description": "There is a major water leak from the underground pipe near Tech junction. Water has been flowing continuously for 2 days now. The road is getting soaked and there is water everywhere. Please send someone urgently.",
    ...
    {
        "report_id": "NX-2026-1002",
        "timestamp": "2026-07-01T14:15:00+05:30",
        "citizen_name": "Priya Sharma",
        "phone": "+91-98200-10002",
        "location": {"latitude": 19.1192, "longitude": 72.8472, "address": "Tech Corridor Main Expressway, Sector A", "ward": "Zone 7 - Metro Tech Corridor"},
        "description": "The road surface near Tech junction has started cracking badly. I think the water leak from the pipe underneath is causing the road to break apart. Vehicles are having difficulty passing through. Very dangerous for two-wheelers.",
    ...
    {
        "report_id": "NX-2026-1003",
        "timestamp": "2026-07-02T09:00:00+05:30",
        "citizen_name": "Amit Patel",
        "phone": "+91-98200-10003",
        "location": {"latitude": 19.1188, "longitude": 72.8468, "address": "Opposite Cyber Galleria, Sector A", "ward": "Zone 7 - Metro Tech Corridor"},
        "description": "A large pothole has formed on the main road opposite Cyber Galleria. It is almost 2 feet deep and filled with muddy water. Yesterday a scooter rider fell into it and got injured. This needs immediate attention.",
    ...
    {
        "report_id": "NX-2026-1004",
        "timestamp": "2026-07-02T16:30:00+05:30",
        "citizen_name": "Sunita Deshpande",
        "phone": "+91-98200-10004",
        "location": {"latitude": 19.1191, "longitude": 72.8469, "address": "Tech Junction Signal Crossway", "ward": "Zone 7 - Metro Tech Corridor"},
        "description": "Severe waterlogging on Tech Corridor road after just light rain. The water is not draining at all. It looks like the road damage and potholes are trapping water. Buses and autos are stuck. Ankle-deep water for pedestrians.",
    ...
    {
        "report_id": "NX-2026-1005",
        "timestamp": "2026-07-03T10:00:00+05:30",
        "citizen_name": "Vikram Singh",
        "phone": "+91-98200-10005",
        "location": {"latitude": 19.1193, "longitude": 72.8471, "address": "Near Tech Metro Central Station", "ward": "Zone 7 - Metro Tech Corridor"},
        "description": "The water pipe is still leaking near Tech junction! Nobody has come to fix it. I submitted a complaint 2 days ago. The water is now spreading to the metro station area. Please escalate this.",
    ...
    {
        "report_id": "NX-2026-1006",
        "timestamp": "2026-07-03T11:30:00+05:30",
        "citizen_name": "Meera Nair",
        "phone": "+91-98200-10006",
        "location": {"latitude": 19.1187, "longitude": 72.8473, "address": "Service Perimeter Road, Sector A", "ward": "Zone 7 - Metro Tech Corridor"},
        "description": "The service road near Tech junction is completely damaged. There are cracks everywhere and the road surface is crumbling. This happened after the water leak started last week. Please repair the road before monsoon season makes it worse.",
...
# Ward 12 → using Zone 6 - Central Transit Ring, radius ~150m, July 2-5

SCENARIO_2_REPORTS = [
    {
        "report_id": "NX-2026-1007",
        "timestamp": "2026-07-02T07:00:00+05:30",
        "citizen_name": "Suresh Joshi",
        "phone": "+91-98200-10007",
        "location": {"latitude": 19.0720, "longitude": 72.8560, "address": "Transit Ring Central Market Road", "ward": "Zone 6 - Central Transit Ring"},
        "description": "The main drain in Central Market area is completely blocked. I can see plastic waste and construction debris clogging the drain mouth. Water is already starting to accumulate on the road even without rain.",
    ...
    {
        "report_id": "NX-2026-1008",
        "timestamp": "2026-07-02T15:00:00+05:30",
        "citizen_name": "Anita Kulkarni",
        "phone": "+91-98200-10008",
        "location": {"latitude": 19.0722, "longitude": 72.8562, "address": "Behind Transit Central Market", "ward": "Zone 6 - Central Transit Ring"},
        "description": "Heavy waterlogging behind Central Market. The blocked drain is causing all the water to stay on the road. Shopkeepers are unable to open their shops. Water is entering ground floor homes.",
    ...
    {
        "report_id": "NX-2026-1009",
        "timestamp": "2026-07-03T08:30:00+05:30",
        "citizen_name": "Manoj Gupta",
        "phone": "+91-98200-10009",
        "location": {"latitude": 19.0719, "longitude": 72.8558, "address": "North Transit Colony Sector 4", "ward": "Zone 6 - Central Transit Ring"},
    ...
    {
        "report_id": "NX-2026-1010",
        "timestamp": "2026-07-03T12:00:00+05:30",
        "citizen_name": "Kavita Iyer",
        "phone": "+91-98200-10010",
        "location": {"latitude": 19.0723, "longitude": 72.8561, "address": "Near Transit Ring Bus Stop", "ward": "Zone 6 - Central Transit Ring"},
    ...
    {
        "report_id": "NX-2026-1011",
        "timestamp": "2026-07-04T09:00:00+05:30",
        "citizen_name": "Deepak Verma",
        "phone": "+91-98200-10011",
        "location": {"latitude": 19.0721, "longitude": 72.8563, "address": "Transit Ring Main Arterial", "ward": "Zone 6 - Central Transit Ring"},
        "description": "Stagnant water on Transit Ring main road for the 3rd day. It is turning green and mosquitoes are breeding. Children in the area are falling sick. Dengue risk is very high. Please take action immediately.",
...
# Zone 3 - Coastal Bay & Education Hub, 2 reports only

SCENARIO_3_REPORTS = [
    {
        "report_id": "NX-2026-1012",
        "timestamp": "2026-07-05T07:45:00+05:30",
        "citizen_name": "Lakshmi Rao",
        "phone": "+91-98200-10012",
        "location": {"latitude": 19.0760, "longitude": 72.8780, "address": "Near Metro Academy Gate, Coastal District", "ward": "Zone 3 - Coastal Bay & Education Hub"},
        "description": "URGENT: There are exposed electrical wires hanging from a broken pole right next to Metro Academy gate. Children walk past this every morning. One wire is almost touching the ground. This is extremely dangerous, especially during rain. Someone could die.",
    ...
    {
        "report_id": "NX-2026-1013",
        "timestamp": "2026-07-05T08:15:00+05:30",
        "citizen_name": "Ramesh Patil",
        "phone": "+91-98200-10013",
        "location": {"latitude": 19.0762, "longitude": 72.8782, "address": "Academy Lane, Coastal District", "ward": "Zone 3 - Coastal Bay & Education Hub"},
        "description": "Broken streetlight on Academy Lane has exposed wires. The insulation has completely worn off. This is right on the path children use to go to school. With monsoon approaching, live wires and water is a deadly combination. Needs emergency response.",
...
# Zone 5 - West Bay Commercial Belt, June 20 - July 5 (spans resolution attempt)

SCENARIO_4_REPORTS = [
    {
        "report_id": "NX-2026-1014",
        "timestamp": "2026-06-20T10:00:00+05:30",
        "citizen_name": "Pooja Mehta",
        "phone": "+91-98200-10014",
        "location": {"latitude": 19.0540, "longitude": 72.8400, "address": "West Bay Hill Avenue", "ward": "Zone 5 - West Bay Commercial Belt"},
        "description": "Large pothole on West Bay Hill Avenue near the signal. Getting bigger every day with the rains. Multiple vehicles have been damaged. Two-wheelers especially at risk. Please fill and repair this urgently.",
        "image_filename": "pothole_02.jpg",
        "status": "SUBMITTED",
        "ward": "Zone 5 - West Bay Commercial Belt",
        "scenario_id": 4,
    },
    {
        "report_id": "NX-2026-1015",
        "timestamp": "2026-06-25T14:00:00+05:30",
        "citizen_name": "Sanjay Tiwari",
        "phone": "+91-98200-10015",
        "location": {"latitude": 19.0541, "longitude": 72.8401, "address": "West Bay Hill Signal", "ward": "Zone 5 - West Bay Commercial Belt"},
        "description": "The pothole on West Bay Hill Avenue I reported 5 days ago has not been fixed. It is now even deeper. Today a delivery boy on a bike fell and fractured his hand. How many injuries will it take before action is taken?",
    ...
    {
        "report_id": "NX-2026-1016",
        "timestamp": "2026-07-03T09:30:00+05:30",
        "citizen_name": "Neha Desai",
        "phone": "+91-98200-10016",
        "location": {"latitude": 19.0540, "longitude": 72.8400, "address": "West Bay Hill Avenue", "ward": "Zone 5 - West Bay Commercial Belt"},
        "description": "The pothole on West Bay Hill Avenue was supposedly repaired last week but the patch has already come off! The pothole is back and even bigger now. Poor quality repair work. Need proper permanent fix this time.",
    ...
    {
        "report_id": "NX-2026-1017",
        "timestamp": "2026-07-05T11:00:00+05:30",
        "citizen_name": "Arun Bhat",
        "phone": "+91-98200-10017",
        "location": {"latitude": 19.0539, "longitude": 72.8402, "address": "Near West Bay Promenade Gateway", "ward": "Zone 5 - West Bay Commercial Belt"},
        "description": "Road around the pothole area on West Bay Hill Avenue is completely damaged now. The failed repair made things worse. Large chunks of road surface have broken off. The whole stretch of 20 meters needs resurfacing.",
...
INDEPENDENT_REPORTS = [
    {
        "report_id": "NX-2026-1018",
        "timestamp": "2026-07-01T20:00:00+05:30",
        "citizen_name": "Rekha Pillai",
        "location": {"latitude": 19.0250, "longitude": 72.8350, "address": "Shahid Bhagat Singh Road, Colaba", "ward": "Zone 1 - Downtown Financial Core"},
        ...
        "ward": "Zone 1 - Downtown Financial Core",
    },
    {
        "report_id": "NX-2026-1019",
        "timestamp": "2026-07-02T06:30:00+05:30",
        "citizen_name": "Ganesh Sawant",
        "location": {"latitude": 19.0255, "longitude": 72.8355, "address": "Colaba Market Lane", "ward": "Zone 1 - Downtown Financial Core"},
    ...
    {
        "report_id": "NX-2026-1020",
        "timestamp": "2026-07-01T09:00:00+05:30",
        "citizen_name": "Divya Menon",
        "location": {"latitude": 19.0320, "longitude": 72.8420, "address": "DN Road, Fort", "ward": "Zone 2 - Port & Logistics Hub"},
        ...
        "ward": "Zone 2 - Port & Logistics Hub",
    },
    {
        "report_id": "NX-2026-1021",
        "timestamp": "2026-07-03T13:00:00+05:30",
        "citizen_name": "Harish Reddy",
        "location": {"latitude": 19.0380, "longitude": 72.8480, "address": "Kala Ghoda Lane, Fort", "ward": "Zone 2 - Port & Logistics Hub"},
    ...
    {
        "report_id": "NX-2026-1022",
        "timestamp": "2026-07-02T11:00:00+05:30",
        "citizen_name": "Swati Jain",
        "location": {"latitude": 19.0650, "longitude": 72.8600, "address": "Grant Road Station Area", "ward": "Zone 4 - Industrial Ring"},
        ...
        "ward": "Zone 4 - Industrial Ring",
    },
    {
        "report_id": "NX-2026-1023",
        "timestamp": "2026-07-04T08:00:00+05:30",
        "citizen_name": "Mukesh Yadav",
        "location": {"latitude": 19.0680, "longitude": 72.8630, "address": "Lamington Road, Grant Road", "ward": "Zone 4 - Industrial Ring"},
    ...
    {
        "report_id": "NX-2026-1024",
        "timestamp": "2026-07-01T12:00:00+05:30",
        "citizen_name": "Preeti Saxena",
        "location": {"latitude": 19.0900, "longitude": 72.8500, "address": "Kurla LBS Road", "ward": "Zone 6 - Central Transit Ring"},
    ...
    {
        "report_id": "NX-2026-1025",
        "timestamp": "2026-07-03T15:00:00+05:30",
        "citizen_name": "Kiran Naik",
        "location": {"latitude": 19.0920, "longitude": 72.8520, "address": "Near Kurla Bus Depot", "ward": "Zone 6 - Central Transit Ring"},
    ...
    {
        "report_id": "NX-2026-1026",
        "timestamp": "2026-07-02T07:00:00+05:30",
        "citizen_name": "Asha Bhosle",
        "location": {"latitude": 19.1300, "longitude": 72.8600, "address": "Goregaon Market Road", "ward": "Zone 8 - Highland Suburban Sector"},
        ...
        "ward": "Zone 8 - Highland Suburban Sector",
    },
    {
        "report_id": "NX-2026-1027",
        "timestamp": "2026-07-04T10:00:00+05:30",
        "citizen_name": "Nitin Chavan",
        "location": {"latitude": 19.1320, "longitude": 72.8620, "address": "Goregaon Link Road", "ward": "Zone 8 - Highland Suburban Sector"},
    ...
    {
        "report_id": "NX-2026-1028",
        "timestamp": "2026-07-01T21:00:00+05:30",
        "citizen_name": "Ritu Agarwal",
        "location": {"latitude": 19.1400, "longitude": 72.8700, "address": "Borivali Station Road", "ward": "Zone 9 - North Lakefront Smart Hub"},
        ...
        "ward": "Zone 9 - North Lakefront Smart Hub",
    },
    {
        "report_id": "NX-2026-1029",
        "timestamp": "2026-07-03T14:00:00+05:30",
        "citizen_name": "Sunil More",
        "location": {"latitude": 19.1420, "longitude": 72.8720, "address": "Borivali West Main Road", "ward": "Zone 9 - North Lakefront Smart Hub"},
    ...
    {
        "report_id": "NX-2026-1030",
        "timestamp": "2026-07-02T08:00:00+05:30",
        "citizen_name": "Anjali Kapoor",
        "location": {"latitude": 19.1500, "longitude": 72.8800, "address": "Thane Border Road", "ward": "Zone 10 - Southern Highway Corridor"},
        ...
        "ward": "Zone 10 - Southern Highway Corridor",
    },
    {
        "report_id": "NX-2026-1031",
        "timestamp": "2026-07-05T09:00:00+05:30",
        "citizen_name": "Venkat Rao",
        "location": {"latitude": 19.1520, "longitude": 72.8820, "address": "Industrial Area, Thane Border", "ward": "Zone 10 - Southern Highway Corridor"},
    ...
    {
        "report_id": "NX-2026-1032",
        "timestamp": "2026-07-04T11:00:00+05:30",
        "citizen_name": "Smita Kulkarni",
        "location": {"latitude": 19.0260, "longitude": 72.8360, "address": "Navy Nagar Road, Colaba", "ward": "Zone 1 - Downtown Financial Core"},
    ...
    {
        "report_id": "NX-2026-1033",
        "timestamp": "2026-07-05T07:30:00+05:30",
        "citizen_name": "Pramod Shirke",
        "location": {"latitude": 19.0910, "longitude": 72.8510, "address": "Kurla East Colony", "ward": "Zone 6 - Central Transit Ring"},
    ...
    {
        "report_id": "NX-2026-1034",
        "timestamp": "2026-07-03T16:00:00+05:30",
        "citizen_name": "Suman Gaikwad",
        "location": {"latitude": 19.1310, "longitude": 72.8610, "address": "Goregaon East Highway Service Road", "ward": "Zone 8 - Highland Suburban Sector"},
    ...
    {
        "report_id": "NX-2026-1035",
        "timestamp": "2026-07-02T06:00:00+05:30",
        "citizen_name": "Ajay Mane",
        "location": {"latitude": 19.1410, "longitude": 72.8710, "address": "Borivali Market Lane", "ward": "Zone 9 - North Lakefront Smart Hub"},
    ...
    {
        "report_id": "NX-2026-1036",
        "timestamp": "2026-07-04T13:00:00+05:30",
        "citizen_name": "Pallavi Datar",
        "location": {"latitude": 19.0330, "longitude": 72.8430, "address": "Horniman Circle Area, Fort", "ward": "Zone 2 - Port & Logistics Hub"},
    ...
    {
        "report_id": "NX-2026-1037",
        "timestamp": "2026-07-01T19:30:00+05:30",
        "citizen_name": "Yogesh Pawar",
        "location": {"latitude": 19.0660, "longitude": 72.8610, "address": "Nana Chowk, Grant Road", "ward": "Zone 4 - Industrial Ring"},
    ...
    {
        "report_id": "NX-2026-1038",
        "timestamp": "2026-07-03T08:00:00+05:30",
        "citizen_name": "Manisha Raut",
        "location": {"latitude": 19.1510, "longitude": 72.8810, "address": "Southern Highway Perimeter Canal", "ward": "Zone 10 - Southern Highway Corridor"},
        "description": "Sewage overflowing from open conduit near Southern Highway. The channel has not been cleaned before monsoon. Unbearable stench in the entire area.",
        "image_filename": "sewage_03.jpg",
        "ward": "Zone 10 - Southern Highway Corridor",
    },
    {
        "report_id": "NX-2026-1039",
        "timestamp": "2026-07-02T14:00:00+05:30",
        "citizen_name": "Tushar Joshi",
        "location": {"latitude": 19.1250, "longitude": 72.8520, "address": "Tech Link Road, Sector C", "ward": "Zone 7 - Metro Tech Corridor"},
        "description": "Garbage dumped illegally on Sector C service road. Someone is dumping construction waste at night. The pile is growing and blocking half the road.",
        "image_filename": "garbage_05.jpg",
        "ward": "Zone 7 - Metro Tech Corridor",
    },
    {
        "report_id": "NX-2026-1040",
        "timestamp": "2026-07-04T07:00:00+05:30",
        "citizen_name": "Leela Hegde",
        "location": {"latitude": 19.1189, "longitude": 72.8471, "address": "Near Tech Metro Pillar 28, Sector A", "ward": "Zone 7 - Metro Tech Corridor"},
        "description": "Water pipe burst near Tech Metro pillar 28. This looks like the same leak others reported but it is getting much worse now. Water is gushing out at high pressure.",
    ...
    {
        "report_id": "NX-2026-1041",
        "timestamp": "2026-07-05T10:00:00+05:30",
        "citizen_name": "Ashok Jadhav",
        "location": {"latitude": 19.0450, "longitude": 72.8550, "address": "West Bay Boulevard", "ward": "Zone 5 - West Bay Commercial Belt"},
        "description": "Road damaged on West Bay Boulevard near commercial plaza. The divider is also broken. Heavy traffic area, very risky for pedestrians crossing.",
        "image_filename": "road_damage_05.jpg",
        "ward": "Zone 5 - West Bay Commercial Belt",
    },
    {
        "report_id": "NX-2026-1042",
        "timestamp": "2026-07-01T15:00:00+05:30",
        "citizen_name": "Nandini Bose",
        "location": {"latitude": 19.0550, "longitude": 72.8450, "address": "West Bay High Street", "ward": "Zone 5 - West Bay Commercial Belt"},
        "description": "Pothole on High Street near the shopping area. Autorickshaws are charging extra to take this route because of road condition. Customers avoiding the market.",
        "image_filename": "pothole_09.jpg",
        "ward": "Zone 5 - West Bay Commercial Belt",
    },
    {
        "report_id": "NX-2026-1043",
        "timestamp": "2026-07-03T11:00:00+05:30",
        "citizen_name": "Vishal Shetty",
        "location": {"latitude": 19.0750, "longitude": 72.8700, "address": "Coastal Bay Link Road", "ward": "Zone 3 - Coastal Bay & Education Hub"},
        "description": "Small water leak from pipe on Coastal Link Road. Not urgent but wasting water. The area becomes slippery for pedestrians when wet.",
        "image_filename": "leak_06.jpg",
        "ward": "Zone 3 - Coastal Bay & Education Hub",
    },
    {
        "report_id": "NX-2026-1044",
        "timestamp": "2026-07-04T06:30:00+05:30",
        "citizen_name": "Uma Maheshwari",
        "location": {"latitude": 19.0850, "longitude": 72.8550, "address": "Transit Ring North Junction", "ward": "Zone 6 - Central Transit Ring"},
        "description": "Garbage overflow at Transit Ring junction. Multiple bins overflowing. Waste scattered by wind and stray animals. Unhygienic for nearby food stalls.",
        "image_filename": "garbage_06.jpg",
        "ward": "Zone 6 - Central Transit Ring",
    },
    {
        "report_id": "NX-2026-1045",
        "timestamp": "2026-07-02T20:30:00+05:30",
        "citizen_name": "Rahul Khare",
        "location": {"latitude": 19.1050, "longitude": 72.8650, "address": "Tech Corridor Sector D", "ward": "Zone 7 - Metro Tech Corridor"},
        "description": "Streetlight not working on Sector D main arterial. Dark stretch of about 200 meters. Safety concern for pedestrians.",
        "image_filename": "streetlight_04.jpg",
        "ward": "Zone 7 - Metro Tech Corridor",
    },
    {
        "report_id": "NX-2026-1046",
        "timestamp": "2026-07-05T12:00:00+05:30",
        "citizen_name": "Sarita Pardeshi",
        "location": {"latitude": 19.1150, "longitude": 72.8750, "address": "Tech Valley Eco Park Road", "ward": "Zone 7 - Metro Tech Corridor"},
        "description": "Drainage issue near Tech Valley Park. Water from the road is not draining into the main retention canal. Puddles forming on the track.",
        "image_filename": "drainage_03.jpg",
        "ward": "Zone 7 - Metro Tech Corridor",
    },
    {
        "report_id": "NX-2026-1047",
        "timestamp": "2026-07-01T07:00:00+05:30",
        "citizen_name": "Dinesh Solanki",
        "location": {"latitude": 19.0950, "longitude": 72.8450, "address": "Transit Colony Central", "ward": "Zone 6 - Central Transit Ring"},
        "description": "Sewage overflow at Transit Colony Central. The old line has burst. Raw sewage flowing on the street. Children play in this area. Major health risk.",
        "image_filename": "sewage_04.jpg",
        "ward": "Zone 6 - Central Transit Ring",
    },
    {
        "report_id": "NX-2026-1048",
        "timestamp": "2026-07-04T16:00:00+05:30",
        "citizen_name": "Madhuri Gokhale",
        "location": {"latitude": 19.0350, "longitude": 72.8400, "address": "Port Promenade Avenue", "ward": "Zone 2 - Port & Logistics Hub"},
        "description": "Exposed wires near Port Promenade. Junction box open and wires visible. High-footfall area with many visitors including children. Risk of electrocution.",
        "image_filename": "exposed_wire_04.jpg",
        "ward": "Zone 2 - Port & Logistics Hub",
    },
    {
        "report_id": "NX-2026-1049",
        "timestamp": "2026-07-03T17:00:00+05:30",
        "citizen_name": "Satish Bhagat",
        "location": {"latitude": 19.0480, "longitude": 72.8520, "address": "West Bay Causeway", "ward": "Zone 5 - West Bay Commercial Belt"},
        "description": "Waterlogging on West Bay Causeway. Every time it rains, this stretch floods. Traffic comes to a standstill. The drainage under the causeway seems inadequate.",
        "image_filename": "waterlogging_05.jpg",
        "ward": "Zone 5 - West Bay Commercial Belt",
    },
    {
        "report_id": "NX-2026-1050",
        "timestamp": "2026-07-05T08:00:00+05:30",
        "citizen_name": "Geeta Mishra",
        "location": {"latitude": 19.1100, "longitude": 72.8600, "address": "Tech Junction Concourse Road", "ward": "Zone 7 - Metro Tech Corridor"},
        "description": "Drain blocked with plastic waste on Concourse road. The drain cover is missing and the open drain is a hazard. Plastic debris visible clogging the flow.",
...
PERCEPTION_LOOKUP = {
    ...
    "exposed_wire_02.jpg": {"issue_type": "BROKEN_STREETLIGHT", "severity": "CRITICAL", "confidence": 0.92, "evidence_text": "Broken streetlight fixture with exposed internal wiring on school path. Housing damaged and live electrical conductors exposed. Combination with wet monsoon conditions creates lethal hazard."},
        ...
        "scenarios": [
            {
                ...
                "ward": "Zone 7 - Metro Tech Corridor",
                "report_ids": [r["report_id"] for r in SCENARIO_1_REPORTS] + ["NX-2026-1040"],
                "expected_incident_id": "INC-NX-2026-001",
            ...
            },
            {
                ...
                "expected_incident_id": "INC-NX-2026-002",
            ...
            },
            {
                ...
                "expected_incident_id": "INC-NX-2026-003",
            ...
            },
            {
                ...
                "expected_incident_id": "INC-NX-2026-004",
